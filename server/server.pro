...
UDP_FWD_SVC_CRYPTOPP_PKG = $$(UDP_FWD_SVC_CRYPTOPP_PKG)
...
QDEP_DEPENDS += \
	Skycoder42/Udp-Forward-Server@1.0.3/protocol/protocol.pri

UDP_FWD_SVC_INSTALL_BINS = $$(UDP_FWD_SVC_INSTALL_BINS)
UDP_FWD_SVC_INSTALL_LIBS = $$(UDP_FWD_SVC_INSTALL_LIBS)
UDP_FWD_SVC_INSTALL_SYSTEMD_UNITS = $$(UDP_FWD_SVC_INSTALL_SYSTEMD_UNITS)
UDP_FWD_SVC_INSTALL_LAUNCHD_AGENTS = $$(UDP_FWD_SVC_INSTALL_LAUNCHD_AGENTS)
